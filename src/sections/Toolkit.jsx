...
import { Layers, Globe, Wifi, GithubIcon } from "lucide-react";
...
export const skills = [
  ...
  {
    name: "Github",
    icon: <GithubIcon name="github" className="w-5 h-5" variant="dark" />,
    color: "text-[#764ABC] border-[#764ABC]/30 hover:shadow-[#764ABC]/30",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-wrap justify-center content-center gap-3 md:gap-5 w-full h-full relative z-10 max-w-4xl">
          {skills.map((skill, i) => (
            <div
              key={i}
